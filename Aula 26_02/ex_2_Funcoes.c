...
int ajustarTemperatura(int temperaturaAtual);
...
int main() {
    ...
    // alterando a variavel de tempSala ou temServidor para se ajustar ao limete.
...
int ajustarTemperatura(int temperaturaAtual){
    if (tempSala > limiteTemperaturaAlerta){
        tempSala = limiteTemperaturaAlerta;
        printf("Ajuste no sensor da Sala para ficar dentro do limite de temperatura");
    }
    if (tempServidor > limiteTemperaturaAlerta ){
        tempServidor = limiteTemperaturaAlerta;
        printf("Ajuste no sensor do Servidor para ficar dentro do limite de temperatura");
    }
